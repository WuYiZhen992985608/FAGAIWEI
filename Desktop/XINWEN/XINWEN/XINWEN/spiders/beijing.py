...
class BeijingSpider(scrapy.Spider):
    ...
    def __init__(self, pagecount=2, *args, **kwargs):
        ...
        self.domain = 'http://fgw.beijing.gov.cn/'

        # 法律
        # self.home_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/flfggz/fl/index.htm'
        # self.page_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/flfggz/fl/index_{}.htm' #共2页
        # 法规
        # self.home_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/flfggz/fg/index.htm'
        # self.page_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/flfggz/fg/index_{}.htm' #共2页
        # 政策规章
        # self.home_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/flfggz/gz/index.htm'
        # self.page_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/flfggz/gz/index_{}.htm' #共6页
        # # 规范性文件
        self.home_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/bwgfxwj/index.htm'
        self.page_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcgk/bwgfxwj/index_{}.htm'  #共5页
        # # 规划计划
        # self.home_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/ghjh/index.htm'
        # self.page_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/ghjh/index_{}.htm'  #共22页
        # # 政策解读
        # self.home_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcjd/index.htm'
        # self.page_indexurl = 'http://fgw.beijing.gov.cn/fgwzwgk/zcjd/index_{}.htm'  #共10页
    ...
    def get_title(self, response):
        title = response.xpath('//div[@class="xl_title"]/text() ').extract_first()
        return title

    def get_content(self, response):
        content = ''
        try:
            content = ''.join(response.xpath('//div[@class="xl_content"]//text()').getall())
        except:
            pass
        return content
    ...
    def get_text(self, response):
        txt = ''
        try:
            txt = ''.join(response.xpath('//div[@class="xl_content"]//text()').getall())
    ...
    def get_symbol(self, response):
        symbol = ''
        try:
            symbol = response.css('.xl_subtitle ::text').extract_first()
        except:
            pass
        return symbol
    ...
    def get_dates(self, response):
        dates = ''
        try:
            dates = (response.xpath('//div[@class="xl_title_sub clearfix"]/p/text()') or response.xpath(
                '//div[@class="xl_title_sub clearfix"]/p[1]/sapn[1]/text()')).extract_first()
        except:
            pass
        return dates
